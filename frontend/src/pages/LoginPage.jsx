      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-6 relative z-10">
        <div className="w-full max-w-md animate-slide-up">
          <div className="flex flex-col items-center text-center mb-5">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card text-brand text-sm font-semibold mb-4">
              <Shield size={16} />
              AI-powered diagnosis
            </div>
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand to-accent flex items-center justify-center shadow-glow mb-2">
              <Sparkles size={26} className="text-white" />
            </div>
            <h1 className="font-display text-3xl sm:text-4xl font-bold text-app leading-tight">{t.appName}</h1>
            <p className="text-app-muted text-base sm:text-lg mt-1">{t.appTagline}</p>
          </div>
          ...
          <p className="text-center text-xs text-app-faint mt-4">
